  ...
  return [
    {
      ...
      content:
        ...
        "2. После него напиши ещё 1–3 предложения в стиле чата. " +
        "Не начинай их заново с приветствия.\n" +
        "3. Не пиши несколько вариантов подписи подряд. Нужен один цельный текст, " +
        "а не набор альтернатив.\n" + 
        "4. Обычно 160–450 символов. Лучше короче и законченно, чем длинно. " +
        "Не превращай всё в одинаковое «доброе утро, хорошего дня».\n" +
        "5. Без хэштегов, markdown, кавычек вокруг ответа и многоточий.\n\n" + 
