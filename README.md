...
- `GEMINI_IMAGE_MODEL` / `GEMINI_IMAGE_MODELS` — опционально, первая/несколько Gemini-моделей для картинок; по умолчанию бот пробует `gemini-2.5-flash-image-preview`, затем `gemini-2.5-flash-image`
